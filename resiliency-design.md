...
It's important to validate offerings are available in the regions you are deploying. Check for paired datacenters and validate if they meet the deployment criteria for client specific requirements.
...
- Replication frequency: The daily replication based on the local time zone.
...
- Volume services to create, delete, and retype enablement to support mirrored volumes
